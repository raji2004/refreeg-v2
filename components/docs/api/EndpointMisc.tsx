      ...
      <div className="space-y-10">
        <header className="space-y-4">
          ...
          <p className="text-slate-500 text-lg font-medium leading-relaxed">
            A specialized endpoint for AI agents to dry-run campaign payloads.
            Use this as your **quality assurance gate** before calling the live
            create endpoint.
          </p>
        </header>
        ...
        <ApiEndpointDoc
          ...
          parameters={[
            ...
            },
            {
              ...
              type: "string",
              required: true,
              description: "Proposed description (min 20 chars).",
            },
            {
              name: "goal_amount",
              type: "number",
            ...
            },
            {
              ...
              required: true,
              description:
                "'manual' (on-demand) or 'automated' (at goal/deadline).",
            },
            {
              ...
              required: false,
              description:
                "10-digit NUBAN. Required if bank_id is not provided.",
            },
            {
              name: "bank_code",
              type: "string",
              required: false,
              description:
                "3-digit bank code (e.g., '058'). Required if bank_id is not provided.",
            },
            {
              ...
              required: false,
              description:
                "Legal account holder name. Required if bank_id is not provided.",
            },
          ]}
          requestExample={`{
          ...
          <div className="relative z-10 flex gap-5">
            ...
            <div className="space-y-4">
              <h4 className="font-bold text-white text-lg">
                Agent Strategy: Self-Correction
              </h4>
              <p className="text-blue-100/70 leading-relaxed text-[15px]">
                When an AI agent receives an error from this endpoint,
                programmatically include the **details** object in your next
                prompt to the LLM. Example prompt:
                <span className="block mt-4 bg-slate-950/50 p-4 rounded-xl border border-white/5 italic text-blue-200">
                  &quot;The RefreeG API rejected the previous JSON because the
                  description was too short. Below are the error details. Please
                  strictly rewrite the JSON to satisfy these constraints:
                  [ERROR_DETAILS]&quot;
                </span>
              </p>
            </div>
    ...
    <div className="space-y-12 animate-in fade-in duration-500">
      <header className="space-y-4">
        ...
        <p className="text-slate-500 text-lg">
          Programmatically report suspicious campaigns.
        </p>
      </header>
      <ApiEndpointDoc
        ...
        parameters={[
          {
            ...
            type: "string",
            required: true,
            description: "High-level reason for report (5-100 characters).",
          },
          {
            name: "message",
            type: "string",
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-500">
      <header className="space-y-4">
        ...
        <p className="text-slate-500 text-lg">
          Query the list of active crowdfunding categories.
        </p>
      </header>
      <ApiEndpointDoc

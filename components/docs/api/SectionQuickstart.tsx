      ...
      <section className="space-y-12">
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-600 text-white text-sm font-bold shadow-lg shadow-blue-500/30">
              1
            </span>
          ...
          <p className="text-slate-600 leading-relaxed text-[15px] pl-12">
            ...
            <Link
              ...
              className="font-bold text-blue-600 hover:text-blue-700 underline underline-offset-4 decoration-blue-200"
            >
              Developer Dashboard
            </Link>{" "}
            and generate a set of Sandbox keys. You will need the
            **rg_test_sk_...** key to proceed.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-slate-600 leading-relaxed text-[15px] pl-12">
            Construct a JSON object with your campaign details. Use the
            flattened bank parameters to simplify settlement in a single
            request.
          </p>
        </div>
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-4 text-[11px] font-bold text-blue-300 uppercase tracking-[0.2em]">
                      bash / curl
                    </span>
                  </div>
     ...
     "bank_account_name": "Dev Test"
            ...
            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 flex gap-4 mt-8">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-[#0A2A5C] text-[15px]">
                  Check the Response
                </h4>
                <p className="text-slate-500 text-[13px] leading-relaxed">
                  A successful request will return a **201 Created** status and
                  a JSON object containing the campaign&apos;s unique UUID.
                </p>
              </div>
            </div>
          </div>

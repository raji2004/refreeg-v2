...
export default function DonorGuarantee() {
  ...
  return (
    ...
    >
      {}
      <motion.div className="text-center w-full mb-8" variants={itemVariants}>
        ...
        <p className="text-sm md:text-base text-gray-600 max-w-4xl mx-auto">
          Transparency for donors. Accountability for cause owners. Safety for
          everyone.
        </p>
      </motion.div>
                ...
                <div className="p-6 md:p-8 pt-0 text-gray-700">
                  <div className="space-y-4">
                    ...
                    <p className="leading-relaxed">
                      RefreeG is committed to protecting both donors and cause
                      owners through our comprehensive dispute resolution
                      system. If you have concerns about how your donation is
                      being used, you can initiate a dispute within 30 days of
                      your contribution.
                    </p>
                    ...
                    <ul className="space-y-2 ml-4">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          File a dispute through your donor dashboard within 30
                          days
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                        <span>
                          Our team reviews the case and contacts the cause owner
                          for clarification
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                        <span>
                          If fraud is confirmed, remaining funds are frozen and
                      ...
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-400 rounded-full mt-2 flex-shrink-0"></span>
                        <span>
                          All disputes are resolved within 5-7 business days
                        </span>
                      </li>
                    </ul>

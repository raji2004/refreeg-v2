...
export function RoutedOnChain() {
  ...
  return (
    <>
      ...
      <section
        ref={stepsRef}
        className="flex w-full space-x-8 py-16"
      >
        ...
        <div className="w-1/2">
          ...
          <div className="border-b pb-4 mb-8">
            <div className="flex items-start gap-4 w-11/12">
              ...
              <div className="space-y-3">
                <div className="font-semibold text-lg">Pick a vetted cause.</div>
          ...
          <div className="border-b pb-4 mb-8">
            <div className="flex items-start gap-4 w-11/12">
              ...
              <div className="space-y-3">
                <div className="font-semibold text-lg">Send. It settles in seconds</div>
                <div className="text-sm">
          ...
          <div className="border-b pb-4 mb-8">
            <div className="flex items-start gap-4 w-11/12">
              ...
              <div className="space-y-3">
                <div className="font-semibold text-lg">Follow it all the way home.</div>
                <div className="text-sm">

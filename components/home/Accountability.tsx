...
export default function Accountability() {
  ...
  return (
    <div
      ref={sectionRef}
      className="bg-[#F1ECDD] px-4 sm:px-8 md:px-12 lg:px-20 py-12 sm:py-16 lg:py-24 my-16 rounded-2xl"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-24 max-w-6xl mx-auto">
        <h1
          ref={headlineRef}
          className="font-serif font-normal text-[#0D0D0D] 
             text-[40px] sm:text-[56px] md:text-[52px] lg:text-[96px] 
             leading-[1.0] m-0 text-center md:text-left"
        >
          Giving,
          <br />
          finally
        ...
        <div className="flex flex-col justify-center mt-8 md:mt-0 lg:mt-32 max-w-md mx-auto md:mx-0">
          <p
            ref={subRef}
            className="text-[#0D0D0D] text-sm sm:text-base leading-relaxed m-0 mb-6 sm:mb-8 text-center md:text-left"
          >
            Whether you give ₦10 or rally ten thousand people, RefreeG turns
            intent into impact you can prove.
          </p>

          <div
            ref={buttonsRef}
            className="flex flex-col sm:flex-row md:flex-col items-center gap-3"
          >
            <Link
              href="/causes"

...
export const API_MODELS: ModelDefinition[] = [
  ...
  },
  {
    id: "referral-model",
    name: "Referral (v1)",
    description: "Tracks users invited to the platform along with campaign attribution data.",
    fields: [
      { name: "id_v1", type: "UUID", description: "Unique identifier" },
      { name: "referrer_id_v1", type: "UUID", isRelation: true, isOptional: true, description: "User who sent the invite" },
      { name: "referee_id_v1", type: "UUID", isOptional: true, isRelation: true, description: "User who joined (once registered)" },
      { name: "referee_email_v1", type: "String", description: "Email address invited" },
      { name: "registered_v1", type: "Boolean", description: "Whether the invitee has created an account" },
      { name: "reward_v1", type: "String", isOptional: true, description: "Reward details" },
      { name: "utm_source_v1", type: "String", isOptional: true, description: "Attribution source" },
      { name: "utm_medium_v1", type: "String", isOptional: true, description: "Attribution medium" },
      { name: "utm_campaign_v1", type: "String", isOptional: true, description: "Attribution campaign" },
      { name: "ip_address_v1", type: "String", isOptional: true, description: "IP address of the referral" },
      { name: "user_agent_v1", type: "String", isOptional: true, description: "Browser/device user agent" },
      { name: "created_at_v1", type: "DateTime", description: "Invite creation timestamp" },
    ]
  },
  {
